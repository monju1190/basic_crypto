  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-3 flex-shrink-0">
        <div>
          <h1 className="text-[24px] font-bold font-headline text-on-surface mb-1">Double Transposition Cipher</h1>
          <p className="text-on-surface-variant text-[16px]">Columnar transposition cipher using two permutation keys.</p>
        </div>
        
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1 min-h-0">
        <div className="lg:col-span-5 flex flex-col space-y-4 h-full min-h-0 overflow-y-auto custom-scrollbar pr-2 pb-2">
